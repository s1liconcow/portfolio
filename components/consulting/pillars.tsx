...
const pillars: Pillar[] = [
  {
    ...
    body: "My home turf. I help teams design authorization that holds up in regulated environments: attribute-based access control, path-aware policies, tamper-proof audit, and human-and-agent approval flows. Drawn from a decade of running access systems at Google scale.",
    outcomes: [
    ...
    glyph: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="30" y="40" width="40" height="38" stroke="currentColor" fill="none" />
        <path d="M38 40 V28 a12 12 0 0 1 24 0 V40" stroke="currentColor" fill="none" />
  ...
  },
  {
    ...
    glyph: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <path d="M10 70 L30 50 L50 60 L70 30 L90 45" stroke="currentColor" fill="none" strokeWidth="1.5" />
  ...
  },
  {
    ...
    glyph: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <circle cx="50" cy="50" r="35" stroke="currentColor" fill="none" opacity="0.5" />
        ...
        <path d="M50 15 L50 85 M15 50 L85 50" stroke="currentColor" opacity="0.5" />
      </svg>
    ),
  },
  {
    ...
    glyph: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <path d="M30 40 L45 65 M70 40 L55 65 M37 30 L63 30" stroke="currentColor" />
      </svg>
    ),
  },
  {
    ...
    glyph: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <path d="M50 15 Q30 30 30 55 Q30 75 50 85 Q70 75 70 55 Q70 30 50 15" stroke="currentColor" fill="none" />
        <circle cx="50" cy="50" r="6" fill="currentColor" />
        <path d="M50 15 V50 M30 55 H70 M35 75 L65 35 M35 35 L65 75" stroke="currentColor" opacity="0.3" />
      </svg>
    ),
  },
]
