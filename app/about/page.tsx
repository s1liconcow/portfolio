  ...
  return (
    <div className="pb-24">
      <PageHero
        ...
        title={
          <>
            A short account of <span className="italic">the person</span> on the
            other end of the email.
          </>
        }
        subtitle={
          <>
            Engineer, manager, dad, builder. Spent the last stretch a Staff
            Engineer and Uber Tech Lead at Google. Chapter author of The Site
            Reliability Workbook and Building Secure and Reliable Systems. Now
            independent and exploring how to make autonomous agentic engineering
            reliable.
          </>
        }
        meta={[
        ...
        <div className="grid grid-cols-12 gap-6 md:gap-10 items-start border-t border-ink-rule/60 pt-12">
          ...
          >
            ...
            <p className="text-[16.5px] leading-[1.65]">
              ...
              for Google Corp Eng, was the primary author of “Eliminating Toil”
              in <em>The Site Reliability Workbook</em> (O’Reilly, 2018), and
              contributed to <em>Building Secure and Reliable Systems</em>{" "}
              (Google, 2020). I’ve also filed a handful of patent disclosures,
              including one on path-aware access control.
            </p>
            <p className="text-[16.5px] leading-[1.65]">
              ...
              . Each one pokes at a different edge of the question: what does
              infrastructure look like when the primary user is an agent, not a
              human?
            </p>
            <p className="text-[16.5px] leading-[1.65]">
              Off the keyboard I’m a dad, archer, hiker, a long-time tinkerer,
              and the proud maintainer of several half-finished side projects.
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-ink-softrule grid grid-cols-2 gap-4 text-[13px]">
              <div>
                ...
                <p className="text-ink-muted leading-[1.6]">
                  Authorization · Data Governance · Zero-Trust · Service Mesh ·
                  SRE · Agentic Systems.
                </p>
              </div>
              <div>
                ...
                <p className="text-ink-muted leading-[1.6]">
                  Rust · Python · Go · TypeScript. Writer, occasional speaker,
                  patient debugger.
                </p>
              </div>
            </div>
        ...
        <div className="border-t border-ink-rule/60 pt-10">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-2 gap-px bg-ink-softrule border border-ink-softrule">
            {[
              ...
              <li key={i} className="bg-paper-light p-8 md:p-10 relative">
